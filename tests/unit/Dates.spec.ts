...
describe('Dates', () => {
  it('returns a formatted date string', () => {
    const date1: Date = new Date('January 17, 2001 03:24:00')
    const date2: Date = new Date('February 29, 2001 03:24:00')
    const date3: Date = new Date('November 28, 2001 03:24:00')
  ...
  it('returns a date object', () => {
    const date1: string = '01-01-2001'
    const date2: string = '02-29-2001'
    const date3: string = '11-28-2001'
  ...
  it('returns a date string', () => {
    const date1: Date = new Date('January 1, 2001 00:00:00')
    const date2: Date = new Date('February 29, 2001 00:00:00')
    const date3: Date = new Date('November 28, 2001 00:00:00')
